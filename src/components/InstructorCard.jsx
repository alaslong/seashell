  ...
  return (
    ...
    >
      ...
      <div className="card-body flex flex-row justify-between items-center w-full">
        ...
        <div className="flex justify-start gap-2">{instructor.classes.slice(0,1).map(course => <span className="badge badge-sm badge-outline badge-accent text-primary rounded-3xl p-3">{course}</span>)}</div>
